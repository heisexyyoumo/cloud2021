...
import com.humorous.springcloud.myhandler.CustomerBlockHandler;
...
public class RateLimitController {
    ...
    public CommonResult byResource() {
        return new CommonResult(true, "200", "按照资源名称限流测试",
                new Payment(2020L, "serial001"));
    }

    public CommonResult handleException(BlockException exception) {
        return new CommonResult(false, "444",
    ...
    public CommonResult byUrl() {
        return new CommonResult(true, "200", "按照byUrl限流测试",
    ...
    public CommonResult customerBlockHandler() {
        return new CommonResult(true, "200", "按照客户自定义限流测试",
